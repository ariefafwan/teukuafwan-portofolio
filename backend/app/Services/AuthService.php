...
class AuthService
{
    ...
    public function generateTokens($user): array
    {
        ...
        $accessToken = $user->createToken('access_token', [EnumTokenAbility::ACCESS_API], $atExpireTime);
        $refreshToken = $user->createToken('refresh_token', [EnumTokenAbility::ISSUE_ACCESS_TOKEN], $rtExpireTime);
