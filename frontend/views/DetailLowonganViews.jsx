...
export const DetailLowonganViews = ({ data }) => {
    const tanggal = (value) => {
                                ...
                                <div className="w-full">
                                    <img
                                        ...
                                        src={
                                            ...
                                            data.logo_perusahaan !== ""
                                                ? `${process.env.NEXT_PUBLIC_BASE_URL}/storage/Logo/${data.logo_perusahaan}`
                                                : "/loading.jpg"
                                        }
                                        alt=""
                                    />
                                    ...
                                    <div className="w-full">
                                        ...
                                        <ul className="mb-4 list-disc list-inside text-gray-500">
                                            {data.data_kualifikasi_umum.map(
                                                (data, index) => (
                                                    <li
                                                        className="mb-2"
                                                        key={index}
                                    ...
                                    {data.data_kualifikasi_prodi.length > 0 ? (
                                        <>
                                            <hr className="my-3 border-gray-200" />
                                            <div className="w-full">
                                                <h6 className="font-semibold text-sm mb-4">
                                                ...
                                                <p className="mb-4 text-gray-500">
                                                    {data.data_kualifikasi_prodi.map(
                                                        (data, index) => {
