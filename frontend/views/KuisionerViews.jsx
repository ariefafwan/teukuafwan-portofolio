...
export const KuisionerViews = ({ data }) => {
    const dataProgramStudi = data.programStudi;
    ...
    useEffect(() => {
        AxiosInstance.get(`/client/pertanyaan`)
            .then((res) => {
                setFormKuisioner(
    ...
    const checkAlumni = (e) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                AxiosInstance.get(
                    `/client/checkAlumni?nik=${formAlumni.nik}&nim=${formAlumni.nim}&id_program_studi=${formAlumni.id_program_studi.value}&jenis_kelamin=${formAlumni.jenis_kelamin}&nama=${formAlumni.nama}`
                )
                    .then((res) => {
                        setDataMahasiswa({
                            id: res.data.id,
        ...
        if (validate) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    AxiosInstance.post(`/client/kuisioner`, valueJawaban)
                        .then((res) => {
                            Swal.fire({
                                title: "Success!",
                                    ...
                                    <div className="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-6">
                                        <div className="md:col-span-6">
                                            ...
                                            <input
                                                ...
                                                className="h-10 border border-gray-200 mt-1 rounded px-4 w-full bg-gray-200"
                                                placeholder="..."
                                                required
                                                disabled
                                            />
                                        ...
                                        <div className="md:col-span-3">
                                            ...
                                            <select
                                                value={formAlumni.jenis_kelamin}
                                                id="jenis_kelamin"
                                                onChange={(e) =>
                                                    setFormAlumni({
                                                        ...formAlumni,
