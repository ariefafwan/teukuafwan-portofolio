      ...
      <footer id="contact">
        <div className="mx-auto max-w-screen-xl px-4 pt-16 pb-8 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-md">
            {/* <hr className="" /> */}
            <div className="inline-flex items-center justify-center w-full space-x-5 p-3 my-1 mx-auto max-w-md border-gray-400 border-t-2">
              <Link className="text-gray-700 transition hover:text-gray-700/75" href={profile.instagram} target="_blank" rel="noreferrer">
                ...
                <svg className="size-6 " fill="#02003f" viewBox="0 0 24 24" aria-hidden="true">
                  <path
                    fillRule="evenodd"
              ...
              <Link className="text-gray-700 transition hover:text-gray-700/75" href={profile.linkedin} target="_blank" rel="noreferrer">
                ...
                <svg className="size-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" fill="#02003f">
              ...
              <Link className="text-gray-700 transition hover:text-gray-700/75" href={profile.kaggle} target="_blank" rel="noreferrer">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="size-5" fill="#02003f">
                  <path
...
l27.666-26.317l99.257,126.294c2.695,3.145,5.839,4.762,9.432,4.762h60.095c3.143,0,4.939-0.899,5.389-2.696L385.708,476.478z"
          ...
          <div className="">
            <p className="text-center text-xs/relaxed text-gray-500">
              ©teukuafwan 2024. All rights reserved.
              <br />
              Created with
      ...
      <div data-dial-init="" className="fixed end-6 bottom-6 group">
        <a
          ...
          className="flex items-center justify-center text-white bg-blue-700 rounded-full w-14 h-14 hover:bg-blue-800 duration-300 hover:scale-110 transform cursor-pointer"
        >
