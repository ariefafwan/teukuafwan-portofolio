...
export const ProjectDetail = () => {
  ...
  const [ProjectData, setProjectData] = useState(project.data.filter((e) => e.id == id)[0]);
  const [OtherProject, setOtherProject] = useState(project.data.filter((e) => e.id != id && e.kategori_project.some((item) => ProjectData.kategori_project.includes(item))));
